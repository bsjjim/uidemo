if (nexacro.NxPivot) {
	...
	_pNxPivot._setContents = function(str)
	{
		...
		if(this.useitems==true)sXML += this.makeItemsXML(this.jsonContents, "fields", null, "전체");
		if(this.useitems==true)sXML += this.makeItemsXML(this.jsonContents, "colAxis", "fields", "열");
		if(this.useitems==true)sXML += this.makeItemsXML(this.jsonContents, "rowAxis", "colAxis", "행");
		if(this.useitems==true)sXML += this.makeItemsXML(this.jsonContents, "values", "rowAxis", "값");
	...
	_pNxPivot.makeItemsXML = function(objJson, sItemsId, sItemsIdBefor, sItemsText){
