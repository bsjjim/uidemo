...
;
	...
	_pDeviceAdaptor.callMethod = function () {
		...
		if (handle) {
			...
			return nexacro._callMethodExtensionAPI.apply(this, arrArguments);
		}
		else {
			trace("no handle");
		}
	...
	if (!nexacro.__isDesignMode || !nexacro.__isDesignMode()) {
		nexacro._loadExtendedLibrary = function (libpath) {
			if (nexacro._Browser == "Runtime") {
		...
		nexacro._loadExtendedLibrary = nexacro._emptyFn;
	}


	nexacro._freeExtendedLibrary = function (handle) {
