		...
		nexacro._print = function (pThis, refform, defaultprint, valign, halign, fitonepage) {
			...
			if (elem && elem.handle) {
				...
				if (pThis._is_scrollable && elem._client_elem && elem._client_elem.handle) {
					ret = nexacro.__print(elem._client_elem.handle, form_elem.handle, defaultprint, valign, halign, fitonepage);
				}
				else {
					ret = nexacro.__print(elem.handle, form_elem.handle, defaultprint, valign, halign, fitonepage);
				}
			}
			return ret;
		};
